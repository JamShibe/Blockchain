...
class Blockchain(object):
    ...
    #Defines Method for creating new Block
    ...
    #Defines Method for creating new transaction
    def new_transaction(self, sender, recipient, amount):
        ...
        #Returns the index of the block that holds the transaction
        return self.last_block['index'] + 1

    #Defines proof of work method
...
def mine():
    #We run PoW algorithm to get next proof
    last_block = blockchain.last_block
    last_proof = last_block['proof']
    proof = blockchain.proof_of_work(last_proof)

    #Recieve reward for finding the proof
    #The sender is "0" to show that this node has mined a new coin
...
def register_nodes():
    ...
    if nodes is None:
        return "Error: {;ease supply a valid list of nodes", 400
